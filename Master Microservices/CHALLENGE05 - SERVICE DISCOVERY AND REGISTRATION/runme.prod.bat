...
cd "./eurekaserver"
call mvn clean
call docker build . -t davidvera/eurekaserver:0.0.5-RELEASE
cd ".."
...
@REM call docker image push docker.io/davidvera/configserver:0.0.5-RELEASE
@REM call docker image push docker.io/davidvera/eurekaserver:0.0.5-RELEASE
...
@REM call docker pull davidvera/configserver:0.0.5-RELEASE
@REM call docker pull davidvera/eurekaserver:0.0.5-RELEASE
...
@REM call docker run -d -p 8080:8080 davidvera/configserver:0.0.5-RELEASE
@REM call docker run -d -p 9000:9000 davidvera/eurekaserver:0.0.5-RELEASE
