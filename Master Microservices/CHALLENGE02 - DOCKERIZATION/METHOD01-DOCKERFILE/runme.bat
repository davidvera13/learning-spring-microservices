...
cd "./accounts"
call mvn clean
call docker build . -t davidvera/accounts:0.0.2-SNAPSHOT
cd ".."

cd "./cards"
call mvn clean
call docker build . -t davidvera/cards:0.0.2-SNAPSHOT
cd ".."

cd "./loans"
call mvn clean
call docker build . -t davidvera/loans:0.0.2-SNAPSHOT
cd ".."
