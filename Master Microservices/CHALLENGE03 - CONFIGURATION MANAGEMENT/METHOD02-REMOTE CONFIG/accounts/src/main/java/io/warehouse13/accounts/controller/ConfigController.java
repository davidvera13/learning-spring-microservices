...
public class ConfigController {
	...
	private final AccountsInfo acountsInfo;
	...
	@Operation(
			summary = "Get build version information from accounts/ microservice",
			description = "Get build information that is deployed in accounts microservice"
	)
	@ApiResponses({
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Get accounts microservice information"
	)
	@ApiResponses({
			@ApiResponse(
					responseCode = "200",
	...
	public ResponseEntity<AccountsInfo> getInfos() {
		return ResponseEntity.ok(acountsInfo);
	}
