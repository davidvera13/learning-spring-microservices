...
public class ConfigController {
	...
	private final LoansInfo loansInfos;
	@Value("${build.version}")
	private String buildVersion;


	@Operation(
			summary = "Get build version information from loans microservice",
			description = "Get build information that is deployed in loans microservice"
	)
	@ApiResponses({
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Get java version used in loans microservice"
	)
	@ApiResponses({
			@ApiResponse(
					responseCode = "200",
	...
	public ResponseEntity<LoansInfo> getInfos() {
		return ResponseEntity.ok(loansInfos);
	}
}
